#ifndef RACER_WAVING_GRASS_PASSES_INCLUDED
#define RACER_WAVING_GRASS_PASSES_INCLUDED

#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/UnityGBuffer.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/ShaderVariablesFunctions.hlsl"
#include "RacerRoadGrassClip.hlsl"
...
void InitializeInputData(GrassVertexOutput input, out InputData inputData)
{
    ...
    #if !UNITY_REVERSED_Z
    clipZ = lerp(UNITY_NEAR_CLIP_VALUE, 1, clipZ);
    #endif
...
#endif
{
    ...
    ClipIfOnRoad(input.posWSShininess.xyz);
...
void InitializeVertData(GrassVertexDepthOnlyInput input, inout GrassVertexDepthOnlyOutput vertData)
{
    VertexPositionInputs vertexInput = GetVertexPositionInputs(input.vertex.xyz);
    vertData.uv = input.texcoord;
    vertData.positionWS = vertexInput.positionWS;
    vertData.clipPos = vertexInput.positionCS;
}
